 ...
 */
 class XCORE_API BaseMotionControl : public Base<BaseMotionControl> {
  public:
   explicit BaseMotionControl(std::shared_ptr<XService> comm);
 ...
 class XCORE_API MotionControl<MotionControlMode::RtCommand> : public BaseMotionControl {
  public:
   ...
   void setControlLoop(const std::function<Command(void)>& callback, int priority = 0, bool useStateDataInLoop = false);
    ...
    * @param[out] ec 错误码
    */
   void automaticErrorRecovery(error_code &ec);
 ...
 class XCORE_API RtMotionControl : public MotionControl<MotionControlMode::RtCommand> {
  ...
  // ***************           控制模式 & 发送运动指令          ***************
    ...
    * @param[out] ec 错误码
    */
   void setCartesianLimit(const std::array<double, 3> &lengths, const std::array<double, 16> &frame, error_code &ec);
    ...
    * @param[out] ec 错误码
    */
   void setEndEffectorFrame(const std::array<double, 16> &frame, error_code &ec);
 ...
 class XCORE_API RtMotionControlCobot: public RtMotionControl<WorkType::collaborative, DoF> {
  public:
    ...
    * @param[out] ec 错误码
    */
   void setJointImpedance(const std::array<double, DoF> &factor, error_code &ec);
    ...
    * @param[out] ec 错误码
    */
   void setCartesianImpedance(const std::array<double, 6> &factor, error_code &ec);
    ...
    * @param[out] ec 错误码
    */
   void setFilterFrequency(double jointFrequency, double cartesianFrequency, double torqueFrequency, error_code &ec);
    ...
    * @param[out] ec 错误码
    */
   void setCartesianImpedanceDesiredTorque(const std::array<double, 6> &torque, error_code &ec);
    ...
    * @param[out] ec 错误码
    */
   void setTorqueFilterCutOffFrequency(double frequency, error_code &ec);

   /**
    * @brief 设置机器人力控坐标系
    * @param[in] frame 力控坐标系相对于法兰坐标系的变换矩阵
    * @param[in] type 类别, 指定哪个坐标系为力控任务坐标系
    * @param[out] ec 错误码
    */
   void setFcCoor(const std::array<double, 16> &frame, ForceControlFrameType type, error_code &ec);
    ...
    * @param[out] ec 错误码
    */
   void setCollisionBehaviour(const std::array<double, DoF> &torqueThresholds, error_code &ec);
