...
void torqueControl(xMateErProRobot &robot) 
{
    ...
    //调用python文件名，不用写后缀
    PyObject* trainingSet = PyImport_ImportModule("GP_fitting1_sparse");
    ...
    position_file.open("./ly_data/SGPR_sparse/joint/s6/position_ly.txt");
    position_error_file.open("./ly_data/SGPR_sparse/joint/s6/position_error_ly.txt");
    velocity_file.open("./ly_data/SGPR_sparse/joint/s6/velocity_file.txt");
    inertia_file.open("./ly_data/SGPR_sparse/joint/s6/inertia_file.txt");
    coriolis_file.open("./ly_data/SGPR_sparse/joint/s6/coriolis_file.txt");
    gravity_file.open("./ly_data/SGPR_sparse/joint/s6/gravity_file.txt");
    torque_file.open("./ly_data/SGPR_sparse/joint/s6/torque_file.txt");
