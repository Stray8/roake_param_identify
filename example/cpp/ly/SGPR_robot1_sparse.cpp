...
void torqueControl(xMateErProRobot &robot) 
{
    ...
    //调用python文件名，不用写后缀
    PyObject* trainingSet = PyImport_ImportModule("GP_fitting2_sparse");
    ...
    position_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/position_ly.txt");
    position_error_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/position_error_ly.txt");
    velocity_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/velocity_file.txt");
    inertia_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/inertia_file.txt");
    coriolis_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/coriolis_file.txt");
    gravity_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/gravity_file.txt");
    torque_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/torque_file.txt");
