...
# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/inertia.txt')[0::gap, :]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/coriolis.txt')[0::gap, :]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/gravity.txt')[0::gap, :]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/torque.txt')[0::gap, :]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/position.txt')[0::gap, :]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/velocity.txt')[0::gap, :]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/inertia.txt')[0::gap, :]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/coriolis.txt')[0::gap, :]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/gravity.txt')[0::gap, :]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/torque.txt')[0::gap, :]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/position.txt')[0::gap, :]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/velocity.txt')[0::gap, :]

inertia = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/inertia.txt')[0::gap, :]
coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/coriolis.txt')[0::gap, :]
gravity = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/gravity.txt')[0::gap, :]
torque = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/torque.txt')[0::gap, :]
q = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/position.txt')[0::gap, :]
dq = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/velocity.txt')[0::gap, :]
...
# 采集的数据集
# np.savetxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/trainingset.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/trainingset.txt', training_set)

np.savetxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SGPR/s1/trainingset.txt', training_set)
