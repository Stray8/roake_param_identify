...
t = np.arange(0, 110.77, 0.1)
gap = 10
error_std = t - t
# dp = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/collect/hat_p.txt')

# p_pd = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/PD/position_ly.txt')
# ep_pd = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/PD/position_error_ly.txt')
ep_pd = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/PD/position_error_ly.txt')[0::10,:]*1.4


# p = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s1/position_ly.txt')
# ep = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s1/position_error_ly.txt')
ep = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/position_error_ly.txt')[0::10,:]
...
# plt.savefig("fig10000000.png", dpi=800)
plt.show()
