...
void torqueControl(xMateErProRobot &robot) 
{
    ...
    // std::ifstream file_position("/home/robot/robot/roake_param_identify/build/ly_data/show/collect/hat_p.txt");
    // std::ifstream file_position("/home/robot/robot/roake_param_identify/build/drag/drag_data/hat_p.txt");
    vector<vector<double>> collect_position(8822, vector<double>(7));//11077
    int rows = 0; // mat行号
    int cols = 0; // mat列号
    string line;
    ...
    // std::ifstream file_velocity("/home/robot/robot/roake_param_identify/build/ly_data/show/collect/hat_dp.txt");
    // std::ifstream file_velocity("/home/robot/robot/roake_param_identify/build/drag/drag_data/hat_dp.txt");
    vector<vector<double>> collect_velocity(8821, vector<double>(7));//11076
    rows = 0;
    cols = 0;
    while (getline(file_position, line))
    {
    ...
    // // position_error_file.open("./drag/PD_error/position_error_ly.txt");
    ...
    position_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/position_ly.txt");
    position_error_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/position_error_ly.txt");
    velocity_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/velocity_file.txt");
    acceleration_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/acceleration_file.txt");
    inertia_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/inertia_file.txt");
    coriolis_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/coriolis_file.txt");
    gravity_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/gravity_file.txt");
    torque_file.open("/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/PD/torque_file.txt");
