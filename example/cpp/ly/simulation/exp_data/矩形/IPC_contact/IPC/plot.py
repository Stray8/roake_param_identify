...
thres_x1 = np.ones(np.shape(thres_y)[0]) * 0.45
thres_x2 = np.ones(np.shape(thres_y)[0]) * 0.3
thres_x = np.arange(0.275, 0.475, 0.01)
thres_y1 = np.ones(np.shape(thres_y)[0]) * (-0.075)
thres_y2 = np.ones(np.shape(thres_y)[0]) * 0.075
...
thres1 = np.ones(np.shape(rx)[0]) * 0.45
thres2 = np.ones(np.shape(rx)[0]) * 0.3
...
thres1 = np.ones(np.shape(rx)[0]) * (-0.075)
thres2 = np.ones(np.shape(rx)[0]) * 0.075
...
plt.savefig("C:/Users/dqjzh/Desktop/impedance_robot/ICRA2022/simulation/figs/RectIPC_contact2.jpg", dpi=150)
plt.savefig("C:/Users/dqjzh/Desktop/impedance_robot/ICRA2022/simulation/figs/RectIPC_contact2.pdf", dpi=1200)
plt.show()
