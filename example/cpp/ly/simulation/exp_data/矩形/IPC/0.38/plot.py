...
thres_x = np.ones(np.shape(thres_y)[0]) * 0.38
...
thres = np.ones(np.shape(rx)[0]) * 0.38
...
plt.savefig("E:/papers/拟投ICRA2022/simulation/figs/RectIPC38.png", dpi=150)
plt.savefig("E:/papers/拟投ICRA2022/simulation/figs/RectIPC38.pdf", dpi=1200)
plt.show()
