...
thres_x = np.ones(np.shape(thres_y)[0]) * 0.40
...
thres = np.ones(np.shape(rx)[0]) * 0.40
...
plt.savefig("E:/papers/拟投ICRA2022/simulation/figs/RectIPC40.jpg", dpi=150)
plt.savefig("E:/papers/拟投ICRA2022/simulation/figs/RectIPC40.pdf", dpi=1200)
plt.show()
