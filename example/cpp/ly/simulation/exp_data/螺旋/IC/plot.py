...
# thres_x = np.ones(np.shape(thres_y)[0]) * 0.46
...
# thres = np.ones(np.shape(rx)[0]) * 0.46
...
plt.savefig("C:/Users/dqjzh/Desktop/impedance_robot/ICRA2022/simulation/figs/SpiralIC.jpg", dpi=150)
plt.savefig("C:/Users/dqjzh/Desktop/impedance_robot/ICRA2022/simulation/figs/SpiralIC.pdf", dpi=1200)
plt.show()
