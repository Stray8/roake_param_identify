...
inertia = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/inertia.txt')[0::gap, :]
coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/coriolis.txt')[0::gap, :]
gravity = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/gravity.txt')[0::gap, :]
torque = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/torque.txt')[0::gap, :]
q = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/position.txt')[0::gap, :]
dq = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/velocity.txt')[0::gap, :]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SGPR/s3/inertia.txt')[0::gap, :]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SGPR/s3/coriolis.txt')[0::gap, :]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SGPR/s3/gravity.txt')[0::gap, :]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SGPR/s3/torque.txt')[0::gap, :]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SGPR/s3/position.txt')[0::gap, :]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SGPR/s3/velocity.txt')[0::gap, :]
