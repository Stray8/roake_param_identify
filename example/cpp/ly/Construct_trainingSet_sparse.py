...
# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/inertia.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/coriolis.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/gravity.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/torque.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/hat_p.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/hat_dp.txt')[0::gap,:]

inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/inertia_file.txt')[0::gap,:]
coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/coriolis_file.txt')[0::gap,:]
gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/gravity_file.txt')[0::gap,:]
torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/torque_file.txt')[0::gap,:]
q = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/position_ly.txt')[0::gap,:]
dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/velocity_file.txt')[0::gap,:]
...
# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_joint/collect/trainingset.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s1/trainingset.txt', training_set)

# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/collect/trainingset.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s5/trainingset.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/PD/trainingset.txt', training_set)

# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/collect/trainingSet_drag.txt', training_set)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/trainingset.txt', training_set)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/qqq.txt', q)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/dqqq.txt', dq)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/dddqqq.txt', ddq)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/hat_qqqq.txt', hat_q)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/hat_dqqq.txt', hat_dq)
np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/hat_dddqqq.txt', hat_ddq)
