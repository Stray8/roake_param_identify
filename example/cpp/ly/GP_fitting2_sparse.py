...
class sgpr:
    def __init__(self, X, y, likelihood_noise=0.4, restart=1):
        '''
        :param X: q, dq, ddq
...
Robot_DOF = 7
# trainingSet_collect = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/show/collect/trainingset.txt')

trainingSet_collect = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/collect/trainingSet_drag.txt')
trainingSet_s1 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s1/trainingset.txt')
trainingSet_s2 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s2/trainingset.txt')
trainingSet_s3 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s3/trainingset.txt')
# trainingSet_s4 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s4/trainingset.txt')

trainingSet = trainingSet_collect
# trainingSet = np.vstack((trainingSet_s1, trainingSet_s2, trainingSet_s3))
