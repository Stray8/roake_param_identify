...
class sgpr:
    def __init__(self, X, y, likelihood_noise=0.3, restart=1):
        '''
        :param X: q, dq, ddq
...
Robot_DOF = 7
# cartesian space
trainingSet_collect = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_collect/trainingSet_drag.txt')
# trainingSet_s1 = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s1/trainingset.txt')
# trainingSet_s2 = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s2/trainingset.txt')[0::4,:]
# trainingSet_s3 = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_SCGP/s3/trainingset.txt')[0::4,:]

# trainingSet_test = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/cartesian/s1/trainingset.txt')
...
# # joint space
# trainingSet_collect = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_collect/trainingset.txt')
# trainingSet_s1 = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SCGP/s1/trainingset.txt')[0::2,:]
# trainingSet_s2 = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SCGP/s2/trainingset.txt')[0::2,:]
# trainingSet_s3 = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/joint/data_SCGP/s3/trainingset.txt')[0::2,:]
...
y5 = Y[:, 5]
y6 = Y[:, 6]
print("size_trainingSet is ", np.shape(trainingSet)[0])
...
def prediction(input):
    ...
    #     pre0[i+1] = 0.5*pre0[i]+0.5*pre0[i+1]
    #     pre1[i+1] = 0.5*pre1[i]+0.5*pre1[i+1]
    #     pre2[i+1] = 0.5*pre2[i]+0.5*pre2[i+1]
    #     pre3[i+1] = 0.5*pre3[i]+0.5*pre3[i+1]
    #     pre4[i+1] = 0.5*pre4[i]+0.5*pre4[i+1]
    #     pre5[i+1] = 0.5*pre5[i]+0.5*pre5[i+1]
    #     pre6[i+1] = 0.5*pre6[i]+0.5*pre6[i+1]
...
# for i in range (data_Size - 1):
    # hat_y0[i+1] = 0.5 * hat_y0[i] + 0.5 * hat_y0[i+1]
    # hat_y1[i+1] = 0.5 * hat_y1[i] + 0.5 * hat_y1[i+1]
    # hat_y2[i+1] = 0.5 * hat_y2[i] + 0.5 * hat_y2[i+1]
    # hat_y3[i+1] = 0.5 * hat_y3[i] + 0.5 * hat_y3[i+1]
    # hat_y4[i+1] = 0.5 * hat_y4[i] + 0.5 * hat_y4[i+1]
    # hat_y5[i+1] = 0.5 * hat_y5[i] + 0.5 * hat_y5[i+1]
    # hat_y6[i+1] = 0.5 * hat_y6[i] + 0.5 * hat_y6[i+1]
...
# 绘制第1个子图：y0和hat_y0
plt.subplot(421)
plt.plot(np.arange(data_Size), y0, color=(26/255, 111/255, 223/255), label='$\mu_1$', lw=2)
plt.plot(np.arange(data_Size), hat_y0, color=(241/255, 64/255, 64/255), label='$\hat \mu_1$', lw=2)
...
# 绘制第2个子图：y1和hat_y1
plt.subplot(422)
plt.plot(np.arange(data_Size), y1, color=(26/255, 111/255, 223/255), label='$\mu_2$', lw=2)
plt.plot(np.arange(data_Size), hat_y1, color=(241/255, 64/255, 64/255), label='$\hat \mu_2$', lw=2)
# plt.ylabel('$mu$')
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=14, loc='upper right')
...
# 绘制第3个子图：y2和hat_y2
plt.subplot(423)
plt.plot(np.arange(data_Size), y2, color=(26/255, 111/255, 223/255), label='$\mu_3$', lw=2)
plt.plot(np.arange(data_Size), hat_y2, color=(241/255, 64/255, 64/255), label='$\hat \mu_3$', lw=2)
plt.ylabel('$\mu$', fontsize=14)
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=14, loc='upper right')
...
# 绘制第4个子图：y3和hat_y3
plt.subplot(424)
plt.plot(np.arange(data_Size), y3, color=(26/255, 111/255, 223/255), label='$\mu_4$', lw=2)
plt.plot(np.arange(data_Size), hat_y3, color=(241/255, 64/255, 64/255), label='$\hat \mu_4$', lw=2)
# plt.ylabel('$mu$')
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=14, loc='upper right')
...
# 绘制第5个子图：y4和hat_y4
plt.subplot(425)
plt.plot(np.arange(data_Size), y4, color=(26/255, 111/255, 223/255), label='$\mu_5$', lw=2)
plt.plot(np.arange(data_Size), hat_y4, color=(241/255, 64/255, 64/255), label='$\hat \mu_5$', lw=2)
plt.ylabel('$\mu$', fontsize=14)
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=14, loc='upper right')
...
# 绘制第6个子图：y5和hat_y5
plt.subplot(426)
plt.plot(np.arange(data_Size), y5, color=(26/255, 111/255, 223/255), label='$\mu_6$', lw=2)
plt.plot(np.arange(data_Size), hat_y5, color=(241/255, 64/255, 64/255), label='$\hat \mu_6$', lw=2)
# plt.ylabel('$mu$')
...
# 绘制第7个子图：y6和hat_y6
plt.subplot(427)
plt.plot(np.arange(data_Size), y6, color=(26/255, 111/255, 223/255), label='$\mu_7$', lw=2)
plt.plot(np.arange(data_Size), hat_y6, color=(241/255, 64/255, 64/255), label='$\hat \mu_7$', lw=2)
plt.ylabel('$\mu$', fontsize=14)
plt.xlabel('steps', fontsize=14)
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=14, loc='upper right')
...
# 显示图形
plt.savefig("prediction_cartesian", dpi=800)
# plt.savefig("prediction_joint", dpi=800)
# plt.savefig("prediction_test", dpi=800)
