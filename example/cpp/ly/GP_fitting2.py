...
Robot_DOF = 7
trainingSet_collect = np.loadtxt('/home/robot/robot/roake_param_identify/example/cpp/ly/compare_SCGP_SGPR/cartesian/data_collect/trainingSet_drag.txt')[0::3,:]
...
# trainingSet = np.hstack((trainingSet2, trainingSet3, trainingSet4, trainingSet5))
