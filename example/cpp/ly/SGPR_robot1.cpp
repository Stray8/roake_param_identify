...
void torqueControl(xMateErProRobot &robot) 
{
    ...
    //调用python文件名，不用写后缀
    PyObject* trainingSet = PyImport_ImportModule("GP_fitting2");
    ...
    //读取acceleration
    // std::ifstream file_acceleration("/home/robot/robot/roake_param_identify/build/drag/drag_data/hat_ddp.txt");
    // vector<vector<double>> collect_acceleration(18478, vector<double>(7));
    // rows = 0;
    // cols = 0;
    ...
    // position_file.open("./drag/simulation_1/position_ly.txt");
    // position_error_file.open("./drag/simulation_1/position_error_ly.txt");
    // velocity_file.open("./drag/simulation_1/velocity_file.txt");
    // inertia_file.open("./drag/simulation_1/inertia_file.txt");
    // coriolis_file.open("./drag/simulation_1/coriolis_file.txt");
    // gravity_file.open("./drag/simulation_1/gravity_file.txt");
    // torque_file.open("./drag/simulation_1/torque_file.txt");

    // position_file.open("./drag/simulation_2/position_ly.txt");
    // position_error_file.open("./drag/simulation_2/position_error_ly.txt");
    // velocity_file.open("./drag/simulation_2/velocity_file.txt");
    // inertia_file.open("./drag/simulation_2/inertia_file.txt");
    // coriolis_file.open("./drag/simulation_2/coriolis_file.txt");
    // gravity_file.open("./drag/simulation_2/gravity_file.txt");
    // torque_file.open("./drag/simulation_2/torque_file.txt");

    // position_file.open("./drag/simulation_3/position_ly.txt");
    // position_error_file.open("./drag/simulation_3/position_error_ly.txt");
    // velocity_file.open("./drag/simulation_3/velocity_file.txt");
    // inertia_file.open("./drag/simulation_3/inertia_file.txt");
    // coriolis_file.open("./drag/simulation_3/coriolis_file.txt");
    // gravity_file.open("./drag/simulation_3/gravity_file.txt");
    // torque_file.open("./drag/simulation_3/torque_file.txt");

    // position_file.open("./drag/simulation_4/position_ly.txt");
    // position_error_file.open("./drag/simulation_4/position_error_ly.txt");
    // velocity_file.open("./drag/simulation_4/velocity_file.txt");
    // inertia_file.open("./drag/simulation_4/inertia_file.txt");
    // coriolis_file.open("./drag/simulation_4/coriolis_file.txt");
    // gravity_file.open("./drag/simulation_4/gravity_file.txt");
    // torque_file.open("./drag/simulation_4/torque_file.txt");

    // position_file.open("./drag/simulation_5/position_ly.txt");
    // position_error_file.open("./drag/simulation_5/position_error_ly.txt");
    // velocity_file.open("./drag/simulation_5/velocity_file.txt");
    // inertia_file.open("./drag/simulation_5/inertia_file.txt");
    // coriolis_file.open("./drag/simulation_5/coriolis_file.txt");
    // gravity_file.open("./drag/simulation_5/gravity_file.txt");
    // torque_file.open("./drag/simulation_5/torque_file.txt");

    // position_file.open("./drag/simulation_6/position_ly.txt");
    // position_error_file.open("./drag/simulation_6/position_error_ly.txt");
    // velocity_file.open("./drag/simulation_6/velocity_file.txt");
    // inertia_file.open("./drag/simulation_6/inertia_file.txt");
    // coriolis_file.open("./drag/simulation_6/coriolis_file.txt");
    // gravity_file.open("./drag/simulation_6/gravity_file.txt");
    // torque_file.open("./drag/simulation_6/torque_file.txt");

    // position_file.open("./ly_data/SGPR_cartesian/s5/position_ly.txt");
    // position_error_file.open("./ly_data/SGPR_cartesian/s5/position_error_ly.txt");
    // velocity_file.open("./ly_data/SGPR_cartesian/s5/velocity_file.txt");
    // inertia_file.open("./ly_data/SGPR_cartesian/s5/inertia_file.txt");
    // coriolis_file.open("./ly_data/SGPR_cartesian/s5/coriolis_file.txt");
    // gravity_file.open("./ly_data/SGPR_cartesian/s5/gravity_file.txt");
    // torque_file.open("./ly_data/SGPR_cartesian/s5/torque_file.txt");

    // position_file.open("./ly_data/SGPR_cartesian1/s1/position_ly.txt");
    // position_error_file.open("./ly_data/SGPR_cartesian1/s1/position_error_ly.txt");
    // velocity_file.open("./ly_data/SGPR_cartesian1/s1/velocity_file.txt");
    // inertia_file.open("./ly_data/SGPR_cartesian1/s1/inertia_file.txt");
    // coriolis_file.open("./ly_data/SGPR_cartesian1/s1/coriolis_file.txt");
    // gravity_file.open("./ly_data/SGPR_cartesian1/s1/gravity_file.txt");
    // torque_file.open("./ly_data/SGPR_cartesian1/s1/torque_file.txt");
