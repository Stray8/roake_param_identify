...
# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/inertia.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/coriolis.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/gravity.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/torque.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/position.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/velocity.txt')[0::gap,:]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/inertia_file.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/coriolis_file.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/gravity_file.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/torque_file.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/position_ly.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/velocity_file.txt')[0::gap,:]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/inertia_file.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/coriolis_file.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/gravity_file.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/torque_file.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/position_ly.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/velocity_file.txt')[0::gap,:]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/inertia_file.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/coriolis_file.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/gravity_file.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/torque_file.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/position_ly.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/velocity_file.txt')[0::gap,:]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/inertia_file.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/coriolis_file.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/gravity_file.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/torque_file.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/position_ly.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/velocity_file.txt')[0::gap,:]

# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/inertia_file.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/coriolis_file.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/gravity_file.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/torque_file.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/position_ly.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/velocity_file.txt')[0::gap,:]


inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/inertia_file.txt')[0::gap,:]
coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/coriolis_file.txt')[0::gap,:]
gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/gravity_file.txt')[0::gap,:]
torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/torque_file.txt')[0::gap,:]
q = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/position_ly.txt')[0::gap,:]
dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/velocity_file.txt')[0::gap,:]


# inertia = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/inertia.txt')[0::gap,:]
# coriolis = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/coriolis.txt')[0::gap,:]
# gravity = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/gravity.txt')[0::gap,:]
# torque = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/torque.txt')[0::gap,:]
# q = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/position.txt')[0::gap,:]
# dq = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/velocity.txt')[0::gap,:]
...
# 采集的数据集
# np.savetxt('/home/robot/robot/roake_param_identify/build/drag/drag_data/trainingSet_drag.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/drag/simulation_1/trainingSet_drag.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/drag/simulation_2/trainingSet_drag.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/drag/simulation_3/trainingSet_drag.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/drag/simulation_4/trainingSet_drag.txt', training_set)
# np.savetxt('/home/robot/robot/roake_param_identify/build/drag/simulation_5/trainingSet_drag.txt', training_set)

np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian/s4/s4.txt', training_set)


# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/hat_q.txt', hat_q)
# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/hat_dq.txt', hat_dq)
# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/hat_ddq.txt', hat_ddq)

# np.savetxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_cartesian1/collect/collect.txt', training_set)
...
# Y
plt.subplot(421)
plt.plot(np.arange(N-2), Y[:, plot_dim], c='blue', label='$\hat t_1$')
plt.legend()
plt.subplot(422)
plt.plot(np.arange(N-2), Y[:, plot_dim+1], c='blue', label='$\hat t_2$')
plt.legend()
plt.subplot(423)
plt.plot(np.arange(N-2), Y[:, plot_dim+2], c='blue', label='$\hat t_3$')
plt.legend()
plt.subplot(424)
plt.plot(np.arange(N-2), Y[:, plot_dim+3], c='blue', label='$\hat t_4$')
plt.legend()
plt.subplot(425)
plt.plot(np.arange(N-2), Y[:, plot_dim+4], c='blue', label='$\hat t_5$')
plt.legend()
plt.subplot(426)
plt.plot(np.arange(N-2), Y[:, plot_dim+5], c='blue', label='$\hat t_6$')
plt.legend()
plt.subplot(427)
plt.plot(np.arange(N-2), Y[:, plot_dim+6], c='blue', label='$\hat t_7$')
plt.legend()
plt.show()