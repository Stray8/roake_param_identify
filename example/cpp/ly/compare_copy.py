...
rsme_pd1 = math.sqrt(np.sum(ep_pd[:,1]**2)/data_size*2)
...
# simulation_1
ep_simulation_1 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s1/position_error_ly.txt')[0::gap,:]

# ep_simulation_1 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_joint/s1/position_error_ly.txt')[0::gap,:]
...
# simulation_2
ep_simulation_2 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s2/position_error_ly.txt')[0::gap,:]

# ep_simulation_2 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_joint/s2/position_error_ly.txt')[0::gap,:]
...
# simulation_3
ep_simulation_3 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s3/position_error_ly.txt')[0::gap,:]

# ep_simulation_3 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_joint/s3/position_error_ly.txt')[0::gap,:]
...
# simulation_4
ep_simulation_4 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s4/position_error_ly.txt')[0::gap,:]

# ep_simulation_4 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_joint/s4/position_error_ly.txt')[0::gap,:]
...
# simulation_5
ep_simulation_5 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s5/position_error_ly.txt')[0::gap,:]
...
# simulation_6
ep_simulation_6 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s5/position_error_ly.txt')[0::gap,:]
...
# im1 = np.random.random(60, 40)
# im2 = np.random.random(60, 40)
# im3 = np.random.random(60, 40)
# im4 = np.random.random(60, 40)
# im5 = np.random.random(60, 40)
# im6 = np.random.random(60, 40)
# im7 = np.random.random(60, 40)
...
plt.savefig('fig101010.png', dpi=800)
plt.show()


# plt.subplot(4,2,1)
# plt.plot(rsme_0, c='red',label='$SGPR_{rsme0}$')
# # plt.plot(mae_0, c='blue',label='$mae_0$')
# plt.ylabel('rsme')
# # plt.xlabel('times')
# plt.legend()
# plt.subplot(4,2,2)
# plt.plot(rsme_1, c='red',label='$rsme_1$')
# # plt.plot(mae_1, c='blue',label='$mae_1$')
# plt.ylabel('rsme')
# # plt.xlabel('times')
# plt.legend()
# plt.subplot(4,2,3)
# plt.plot(rsme_2, c='red',label='$rsme_2$')
# # plt.plot(mae_2, c='blue',label='$mae_2$')
# plt.ylabel('rsme')
# # plt.xlabel('times')
# plt.legend()
# plt.subplot(4,2,4)
# plt.plot(rsme_3, c='red',label='$rsme_3$')
# # plt.plot(mae_3, c='blue',label='$mae_3$')
# plt.ylabel('rsme')
# # plt.xlabel('times')
# plt.legend()
# plt.subplot(4,2,5)
# plt.plot(rsme_4, c='red',label='$rsme_4$')
# # plt.plot(mae_4, c='blue',label='$mae_4$')
# plt.ylabel('rsme')
# # plt.xlabel('times')
# plt.legend()
# plt.subplot(4,2,6)
# plt.plot(rsme_5, c='red',label='$rsme_5$')
# # plt.plot(mae_5, c='blue',label='$mae_5$')
# plt.ylabel('rsme')
# plt.xlabel('times')
# plt.legend()
# plt.subplot(4,2,7)
# plt.plot(rsme_6, c='red',label='$rsme_6$')
# # plt.plot(mae_6, c='blue',label='$mae_6$')
# plt.ylabel('rsme')
# plt.xlabel('times')
# plt.legend()
