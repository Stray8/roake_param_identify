...
class sgpr:
    def __init__(self, X, y, likelihood_noise=0.2, restart=1):
        '''
        :param X: q, dq, ddq
...
Robot_DOF = 7
trainingSet_collect = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/collect/trainingset.txt')
trainingSet_PD = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/PD/trainingset.txt')
trainingSet_s1 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s1/trainingset.txt')
trainingSet_s2 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s2/trainingset.txt')
trainingSet_s3 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s3/trainingset.txt')
trainingSet_s4 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s4/trainingset.txt')
trainingSet_s5 = np.loadtxt('/home/robot/robot/roake_param_identify/build/ly_data/SGPR_sparse/joint/s5/trainingset.txt')
...
# trainingSet = np.vstack((trainingSet_collect, trainingSet_s1, trainingSet_s2, trainingSet_s3, trainingSet_s4, trainingSet_s5))

# trainingSet = np.vstack((trainingSet_collect, trainingSet_s1, trainingSet_s2))
trainingSet = trainingSet
print(np.shape(trainingSet)[0])
...
np.savetxt('/home/robot/robot/roake_param_identify/example/cpp/ly/Y.txt', Y)
...
np.savetxt('/home/robot/robot/roake_param_identify/example/cpp/ly/pre.txt', pre)
...
# 绘制第1个子图：y0和hat_y0
plt.subplot(421)
plt.plot(np.arange(data_Size), y0, color=(26/255, 111/255, 223/255), label='$\mu_{real1}$')
plt.plot(np.arange(data_Size), hat_y0, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP1}$')
...
# 绘制第2个子图：y1和hat_y1
plt.subplot(422)
plt.plot(np.arange(data_Size), y1, color=(26/255, 111/255, 223/255), label='$\mu_{real2}$')
plt.plot(np.arange(data_Size), hat_y1, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP2}$')
# plt.ylabel('$mu$')
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=12, loc='upper right')
...
# 绘制第3个子图：y2和hat_y2
plt.subplot(423)
plt.plot(np.arange(data_Size), y2, color=(26/255, 111/255, 223/255), label='$\mu_{real3}$')
plt.plot(np.arange(data_Size), hat_y2, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP3}$')
plt.ylabel('$\mu$',fontsize=12)
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=12, loc='upper right')
...
# 绘制第4个子图：y3和hat_y3
plt.subplot(424)
plt.plot(np.arange(data_Size), y3, color=(26/255, 111/255, 223/255), label='$\mu_{real4}$')
plt.plot(np.arange(data_Size), hat_y3, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP4}$')
# plt.ylabel('$mu$')
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=12, loc='upper right')
...
# 绘制第5个子图：y4和hat_y4
plt.subplot(425)
plt.plot(np.arange(data_Size), y4, color=(26/255, 111/255, 223/255), label='$\mu_{real5}$')
plt.plot(np.arange(data_Size), hat_y4, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP5}$')
plt.ylabel('$\mu$',fontsize=12)
# plt.xlabel('steps')
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=12, loc='upper right')
...
# 绘制第6个子图：y5和hat_y5
plt.subplot(426)
plt.plot(np.arange(data_Size), y5, color=(26/255, 111/255, 223/255), label='$\mu_{real6}$')
plt.plot(np.arange(data_Size), hat_y5, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP6}$')
# plt.ylabel('$mu$')
...
# 绘制第7个子图：y6和hat_y6
plt.subplot(427)
plt.plot(np.arange(data_Size), y6, color=(26/255, 111/255, 223/255), label='$\mu_{real7}$')
plt.plot(np.arange(data_Size), hat_y6, color=(241/255, 64/255, 64/255), label='$\hat \mu_{SCGP7}$')
plt.ylabel('$\mu$',fontsize=12)
plt.xlabel('steps',fontsize=12)
plt.tick_params(direction='in', which='both')
plt.legend(fontsize=12, loc='upper right')
...
# 显示图形
# plt.savefig("fig888999.png", dpi=1000)
plt.show()
